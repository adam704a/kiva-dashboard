package org.kivadashboard.client.command
{
	...
	public class GetAfricaLoanTotalsCommand implements ICommand, IResponder
	{


		private static var AFRICA_REGION_CODE:String = "af";


		public function execute(event:CairngormEvent):void
		{
			var delegate : GetLoansDelegate = new GetLoansDelegate( this );
			delegate.getLoansByCountry(AFRICA_REGION_CODE);
		}
		...
		public function result(data:Object):void
		{
			...
			kivaModel.africaLoanCount =  resultEvent.result.response.paging.total;
			trace("Found " + kivaModel.africaLoanCount + " total Africa Loans");
			
		}
		
		public function fault(info:Object):void
		{
			trace("We have a problem getting the African loan totals");
		}
